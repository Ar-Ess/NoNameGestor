...
// Include minimal core type/macros used by other single-purpose headers.
// This prevents circular includes between soloud.h <-> soloud_*.h
#include "Framework/External/SoLoud/include/soloud_types.h"
...
namespace SoLoud
{
	...
	public:
		...
		int mFloats; // windowSize of buffer (w/out padding)
...
#include "Framework/External/SoLoud/include/soloud_filter.h"
#include "Framework/External/SoLoud/include/soloud_fader.h"
#include "Framework/External/SoLoud/include/soloud_audiosource.h"
#include "Framework/External/SoLoud/include/soloud_bus.h"
#include "Framework/External/SoLoud/include/soloud_queue.h"
#include "Framework/External/SoLoud/include/soloud_error.h"
...
namespace SoLoud
{
	...
	public:
		...
		// Returns current backend buffer windowSize
	...
	public:
		...
		// Draw overall volume from set and 3d volumes
		void updateVoiceVolume_internal(unsigned int aVoice);
		// Draw overall relative play speed from set and 3d speeds
		...
		// Current windowSize of the scratch, in samples.
		...
		// Maximum windowSize of output buffer; used to calculate needed scratch.
