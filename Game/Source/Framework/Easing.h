...
public:
	...
	float Ease(float start, float end, float dt);
...
private:
	...
	// Eases
	double LinearEaseIn    (double t, double d);
	double LinearEaseOut   (double t, double d);
	double LinearEaseInOut (double t, double d);
